    ...
    <div class="admin-container">
        <aside class="sidebar">
            <div class="container-home">
                <a href="#" class="btn-add active" data-page="employee_addition.php">Add Employee</a>
            </div>
            <div class="container-home">
            ...
            <div class="container-home">
                <a href="#" class="btn-add" data-page="create_services.php">Add Service</a>
            </div>
            <div class="container-home">
                <a href="#" class="btn-add" data-page="./includes/view_services.php">View Services</a>
            </div>
            <div class="container-home">
                <a href="#" class="btn-add" data-page="report.php">Generate Report</a>
            </div>
        </aside>
